// Brand icons not available in lucide-react — custom lightweight SVG components
...
export function GoogleScholarIcon({ size = 18, className = "" }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
